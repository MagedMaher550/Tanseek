...
class CommercialSecondary extends StatefulWidget {
  @override
  _CommercialSecondaryState createState() => _CommercialSecondaryState();
}

class _CommercialSecondaryState extends State<CommercialSecondary> {
  double score;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text("تنسيق ثانوي تجاري")),
      ),
          ...
          child: Container(
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child: AdmobBanner (
                      adUnitId: "ca-app-pub-3173563832146472/3665973844",
